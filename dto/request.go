...
type RequestBody struct {
	// 公共参数
	AppKey     string `json:"app_key" url:"app_key" structs:"app_key"`             // 联盟分配 app key
	Format     string `json:"format" url:"format" structs:"format"`                // 格式
	Method     string `json:"method" url:"method" structs:"method"`                // 接口名称
	SignMethod string `json:"sign_method" url:"sign_method" structs:"sign_method"` // 生成签名的算法
	...
	// 业务参数
	ParamJSON UserAccountDeviceInfoRequest `json:"param_json" url:"param_json" structs:"param_json"`
}
